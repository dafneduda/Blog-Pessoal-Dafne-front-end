...
import loginLogo from '../../assets/img/perfil.jpeg'
...
function Perfil() {
  ...
  return (
    <div className='container mx-auto mt-4 rounded-2xl overflow-hidden'>
      ...
      <div className="relative mt-[-6rem] h-72 flex flex-col bg-rose-500 text-white text-2xl items-center justify-center">
